...
use {
    ...
    spl_token_2022::serialization::coption_fromstr,
};
...
impl From<spl_token::instruction::AuthorityType> for AuthorityType {
    fn from(value: spl_token::instruction::AuthorityType) -> Self {
        match value {
            spl_token::instruction::AuthorityType::MintTokens => AuthorityType::MintTokens,
            spl_token::instruction::AuthorityType::FreezeAccount => AuthorityType::FreezeAccount,
            spl_token::instruction::AuthorityType::AccountOwner => AuthorityType::AccountOwner,
            spl_token::instruction::AuthorityType::CloseAccount => AuthorityType::CloseAccount,
        }
    }
}

impl<'a> From<spl_token::instruction::TokenInstruction<'a>> for TokenInstruction {
    fn from(value: spl_token::instruction::TokenInstruction<'a>) -> Self {
        match value {
            ...
            spl_token::instruction::TokenInstruction::InitializeMultisig { m } => {
            ...
            spl_token::instruction::TokenInstruction::Revoke => TokenInstruction::Revoke,
            ...
            spl_token::instruction::TokenInstruction::ThawAccount => TokenInstruction::ThawAccount,
            ...
            spl_token::instruction::TokenInstruction::SyncNative => TokenInstruction::SyncNative,
            spl_token::instruction::TokenInstruction::InitializeAccount3 { owner } => {
                TokenInstruction::InitializeAccount3 { owner }
            }
            spl_token::instruction::TokenInstruction::InitializeMultisig2 { m } => {
            ...
            spl_token::instruction::TokenInstruction::GetAccountDataSize => {
                TokenInstruction::GetAccountDataSize
            }
            spl_token::instruction::TokenInstruction::InitializeImmutableOwner => {
                TokenInstruction::InitializeImmutableOwner
            }
            spl_token::instruction::TokenInstruction::AmountToUiAmount { amount } => {
                TokenInstruction::AmountToUiAmount { amount }
            }
            spl_token::instruction::TokenInstruction::UiAmountToAmount { ui_amount } => {
