...
impl<'a> From<spl_token_2022::instruction::TokenInstruction<'a>> for TokenInstruction {
    fn from(value: spl_token_2022::instruction::TokenInstruction<'a>) -> Self {
        match value {
            ...
            spl_token_2022::instruction::TokenInstruction::InitializeMultisig { m } => {
            ...
            spl_token_2022::instruction::TokenInstruction::Revoke => TokenInstruction::Revoke,
            ...
            spl_token_2022::instruction::TokenInstruction::MintToChecked { amount, decimals } => {
                TokenInstruction::MintToChecked { amount, decimals }
            }
            spl_token_2022::instruction::TokenInstruction::BurnChecked { amount, decimals } => {
                TokenInstruction::BurnChecked { amount, decimals }
            }
            spl_token_2022::instruction::TokenInstruction::InitializeAccount2 { owner } => {
                TokenInstruction::InitializeAccount2 { owner }
            }
            spl_token_2022::instruction::TokenInstruction::SyncNative => {
                TokenInstruction::SyncNative
            }
            spl_token_2022::instruction::TokenInstruction::InitializeAccount3 { owner } => {
                TokenInstruction::InitializeAccount3 { owner }
            }
            spl_token_2022::instruction::TokenInstruction::InitializeMultisig2 { m } => {
            ...
            spl_token_2022::instruction::TokenInstruction::AmountToUiAmount { amount } => {
                TokenInstruction::AmountToUiAmount { amount }
            }
            spl_token_2022::instruction::TokenInstruction::UiAmountToAmount { ui_amount } => {
            ...
            spl_token_2022::instruction::TokenInstruction::ConfidentialMintBurnExtension => {
                TokenInstruction::ConfidentialMintBurnExtension
            }
            spl_token_2022::instruction::TokenInstruction::ScaledUiAmountExtension => {
